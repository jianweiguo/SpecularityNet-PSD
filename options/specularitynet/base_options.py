...
class BaseOptions(Base):
    def initialize(self):
        ...
        self.parser.add_argument('--inet', type=str, default='specularitynet', help='chooses which architecture to use for inet.')
        self.parser.add_argument('--iters', type=int, default=1, help='iters')
        self.parser.add_argument('--enhance', type=str,default='de', choices=['se','de',None,'None'], help='channel enhance method')
        self.parser.add_argument('--ppm', default=True, help='chooses which architecture to use for inet.')
        self.parser.add_argument('--icnn_path', type=str, default=None, help='icnn checkpoint to use.')
        self.parser.add_argument('--suffix', type=str, default=None, help='suffix for results')
    ...
    def parse(self):
        ...
        self.opt.ppmd = bool_dict[self.opt.ppm]
        if self.opt.enhance == "None":
            self.opt.enhance = None
        self.opt.noise = bool_dict[self.opt.noise]
